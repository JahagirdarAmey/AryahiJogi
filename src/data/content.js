export const content = {
  ...
  publications: [
    {
      title: "Maya and Jasper's Engineering Adventure",
      type: "Children's Book",
      description: "A children's book designed to introduce elementary school students to the many fields of engineering. Distributed over 100 copies through school visits, library presentations, and community events.",
      pdf: "/assets/docs/Final book.pdf",
      tags: ["STEM Outreach", "Education", "Engineering"]
    },
    {
  ...
  projects: [
    {
      ...
      company: "Independent",
      period: "Current",
      description: "Developing Maya and Jasper's Engineering Adventure to address the lack of awareness regarding engineering disciplines.",
      points: [
  ...
  coursework: {
    ap: [
      ...
      { name: "AP Psychology", description: "Study of human behavior and mental processes." },
      { name: "AP Calculus AB", description: "Differential and integral calculus." },
      { name: "AP European History", description: "Advanced study of European history and historical analysis." },
      { name: "AP English Language and Composition", description: "Rhetoric, analysis, and writing skills." },
      { name: "AP Spanish and Culture", description: "Advanced Spanish language proficiency and cultural studies." },
      { name: "AP Physics C (Senior Year)", description: "Calculus-based university-level physics." },
      { name: "AP Computer Science (Senior Year)", description: "Fundamental programming and algorithms." },
      { name: "AP Environmental Science (Senior Year)", description: "Interdisciplinary study of ecological systems." }
    ],
    honors: [
